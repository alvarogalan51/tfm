...
test_image_paths  = cell(num_categories * num_test_per_cat, 1);
...
for i=1:num_categories
   images = dir( fullfile(data_path, 'train', categories{i}, '*.png'));
   ...
   images = dir( fullfile(data_path, 'test', categories{i}, '*.png'));
